...
<div class="grid gap-5 md:grid-cols-2">
    ...
    <label class="grid gap-2 text-sm font-medium text-slate-700">Current Leader
        ...
        @if ($members->isEmpty())
            <span class="text-xs text-slate-500">Add members to this Hugpong Banay before selecting a leader.</span>
        @endif
    </label>
...
<p class="mt-4 text-sm text-slate-500">Only active members already assigned to this Hugpong Banay can be selected as leader.</p>
